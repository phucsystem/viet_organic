...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footerbottom,#module-footerleft,#module-footerright,#module-footertop,#module-newstext,#module-headertop,#module-productblock,#module-newscms').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footerbottom,#module-footerleft,#module-footerright,#module-footertop,#module-newstext,#module-headertop,#module-productblock,#module-newscms').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>