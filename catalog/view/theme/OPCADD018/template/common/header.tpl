...
<header>
  <div class="container">
	...
	<div class="head-right">
	  <div class="col-sm-4 header-right">
			<div class="phone"><a href="<?php echo $contact; ?>"></a> <h4><?php echo $text_contact; ?> </h4><span>No: <?php echo $telephone; ?></span></div>
	  </div>
	  <div class="col-sm-4 header-cart"><?php echo $cart; ?></div>
	</div>  
