...
<head>
    ...
    <link media="all" type="text/css" href="http://fonts.googleapis.com/css?family=Open+Sans:400,600,700&subset=latin,latin-ext" rel="stylesheet">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <a href="<?php echo $category['children'][$i]['href']; ?>" class="activSub">
                                    ...
                                    <ul class="col<?php echo $j; ?>">
                                        ...
                                        <li>
                                            <a href="<?php echo $category['children'][$i]['childs'][$wi]['href']; ?>">
                                                <?php echo $category['children'][$i]['childs'][$wi]['name']; ?>
                                            </a>
                                        </li>
                                        <?php } ?>
                                    </ul>
