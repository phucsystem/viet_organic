...
<div class="quickview-container">
    ...
    <?php } ?>
		...
		<div class="product-rightinfo">	
            ...
            <button type="button"  class="btn btn-default wishlist" title="<?php echo $button_wishlist; ?>" onclick="parent.wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i><span><?php echo $button_wishlist; ?></span></button>
            <button type="button"  class="btn btn-default compare" title="<?php echo $button_compare; ?>" onclick="parent.compare.add('<?php echo $product_id; ?>');"><i class="fa fa-area-chart"></i><span><?php echo $button_compare; ?></span></button>
          </div>
		...
		success: function(json) {
			...
			if (json['success']) {		
				...
				parent.$.notify({
					...
					parent.$('#cart > button').html('<div class="cart-border"><h4>Shopping Cart</h4><span id="cart-total">' + json['total'] + '</span></div>' );
