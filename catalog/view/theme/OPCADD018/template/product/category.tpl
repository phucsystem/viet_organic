    ...
    <div id="content" class="<?php echo $class; ?> category "><?php echo $content_top; ?>
     ...
     <!-- <div class="row">-->
        ...
        <div class="col-sm-12 category_list">
		 <h4 class="refine-search"><?php echo $text_refine; ?></h4>
          <ul>
			...
			<div class="product-details list">
			 <div class="caption"> 	
               ...
               <div class="button-group list">
                <button type="button" class="wishlist"   onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i><span><?php echo $button_wishlist; ?></span></button>
                <button type="button" class="compare"  onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-bar-chart"></i><span><?php echo $button_compare; ?></span></button>
              </div>
		</div>
			  <div class="list-right">
			  <div class="button-group list"> <button type="button" class="addtocart" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><?php echo $button_cart; ?></button></div>
			  <?php if ($product['price']) { ?>
                <p class="price">
                  <?php if (!$product['special']) { ?>
                  <?php echo $product['price']; ?>
